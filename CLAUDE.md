...
# Gerar build TypeScript em ./dist
pnpm build
...
Nao ha script de teste configurado ainda.
...
- Variaveis de ambiente: `PORT`, `DATABASE_URL`, `BETTER_AUTH_SECRET`, `BETTER_AUTH_URL`, `API_BASE_URL`, `WEB_APP_BASE_URL`, `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`, `GOOGLE_GENERATIVE_AI_API_KEY`
